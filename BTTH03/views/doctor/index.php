...
<body>
    ...
    <main class="container vh-100 mt-5">
        <div>
            ...
            ?>
            <a href="<?=DOMAIN.'/views/index.php?controller=doctor&action=add'; ?>" class="btn btn-success">Thêm mới</a>
            <table class="table">
                <thead>
                    <tr>
                        <th scope="col">#</th>
                ...
                ?>
                    <tbody>
                        <tr>
                            ...
                            <td><?=$doctor->getSpecial(); ?></td>
                            <td><a href="<?=DOMAIN."/views/index.php?controller=doctor&action=edit&id={$doctor->getId()}"; ?>"><i class="bi bi-pencil-square"></i></a></td>
                            <td>
                                <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#doctor<?= $doctor->getId(); ?>"><i class="bi bi-trash-fill"></i>
                                </button>
                                <div class="modal fade" id="doctor<?= $doctor->getId(); ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                Delete the doctor has id: <?=$doctor->getId(); ?>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                                <a href="<?=DOMAIN."/views/index.php?controller=doctor&action=delete&id={$doctor->getId()}"; ?>" class="btn btn-danger">OK</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
